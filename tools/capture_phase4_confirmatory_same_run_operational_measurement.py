"""Capture the frozen same-run Corpus-v2 operational development cell."""
...
if __name__ == "__main__":
    ...
    require_launcher("phase4_confirmatory_same_run_operational_capture_py")
