"""Capture the frozen H=4096 same-run Corpus-v2 operational development cell."""
...
def main(argv: Sequence[str] | None = None, *, testing: bool = False) -> int:
    return implementation.main(
        ...
        authority_label="H=4096 same-run",
    )
...
if __name__ == "__main__":
    ...
    require_launcher("phase4_confirmatory_h4096_same_run_operational_capture_py")
