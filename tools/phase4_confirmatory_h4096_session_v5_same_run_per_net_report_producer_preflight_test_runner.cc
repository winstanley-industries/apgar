...
using apgar::benchmark::internal::Phase4H4096SessionV5SameRunPerNetReportProducerIdentity;
...
[[nodiscard]] std::optional<Phase4PairedTrialError> RunPreflight(std::string_view runtime_commit) {
  const Phase4H4096SessionV5SameRunPerNetReportProducerIdentity identity = apgar::benchmark::
  ...
  return apgar::benchmark::internal::
      PreflightPhase4ConfirmatoryH4096SessionV5SameRunPerNetReportProducer(identity, source);
}
