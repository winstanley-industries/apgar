...
- P4R-02B is complete in PR #16, and P4R-03 is complete in PR #17 with
  ...
  pools. P4R-04 is active on bounded deterministic CPU candidate-pool
  preparation. P4R-05's sequential baseline, pricing, and later allocator work
  remain closed.
...
| P4R-04 | Add bounded deterministic CPU candidate-pool preparation. | P4R-03 | Exact admission, stable publication order, bounded failure behavior, and worker-count invariance. | `active` | P4R-04 review in progress |
