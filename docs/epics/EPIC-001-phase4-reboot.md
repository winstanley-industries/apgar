...
- P4R-06's bounded candidate-allocator prices and deterministic
...
| P4R-09 | Add fixed-pool Multi-World as a reference extension, without interleaved world-dependent publication. | P4R-08 | Common starting pool/state, deterministic worlds, bounded retention, and stable preferred outcome. | `active` | [draft PR #23](https://github.com/winstanley-industries/apgar/pull/23) |
