#ifndef APGAR_SRC_BENCHMARK_PHASE4_CONFIRMATORY_H4096_SESSION_V5_SAME_RUN_PER_NET_REPORT_PRODUCER_PREFLIGHT_INTERNAL_H_
#define APGAR_SRC_BENCHMARK_PHASE4_CONFIRMATORY_H4096_SESSION_V5_SAME_RUN_PER_NET_REPORT_PRODUCER_PREFLIGHT_INTERNAL_H_
...
inline constexpr std::string_view kPhase4H4096SessionV5SameRunPerNetReportProducerInvariant =
...
// named same-run producer boundary. It is compiled identity, not serialized
// evidence and not a caller-selectable report configuration.
struct Phase4H4096SessionV5SameRunPerNetReportProducerIdentity {
  ...
  std::string_view retained_telemetry_predecessor_authority;
  ...
  Phase4H4096SessionV5Carrier carrier = Phase4H4096SessionV5Carrier::kSameRun;

  std::uint32_t raw_schema_version = 0;
  std::uint32_t raw_wire_schema_version = 0;
  std::uint32_t raw_pair_attempt_count = 0;
  std::uint32_t raw_arm_attempt_count = 0;
  std::uint32_t telemetry_schema_version = 0;
  std::uint32_t telemetry_wire_schema_version = 0;
  std::uint32_t telemetry_pair_capture_count = 0;
  std::uint32_t telemetry_arm_capture_count = 0;
  std::uint32_t telemetry_workload_net_count_per_arm = 0;
  std::uint32_t telemetry_total_per_net_row_count = 0;
  ...
  friend bool operator==(const Phase4H4096SessionV5SameRunPerNetReportProducerIdentity&,
                         const Phase4H4096SessionV5SameRunPerNetReportProducerIdentity&) = default;
};

[[nodiscard]] Phase4H4096SessionV5SameRunPerNetReportProducerIdentity
...
#endif  // APGAR_SRC_BENCHMARK_PHASE4_CONFIRMATORY_H4096_SESSION_V5_SAME_RUN_PER_NET_REPORT_PRODUCER_PREFLIGHT_INTERNAL_H_
