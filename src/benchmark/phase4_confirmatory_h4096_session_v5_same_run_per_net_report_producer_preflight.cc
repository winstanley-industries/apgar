...
Phase4H4096SessionV5SameRunPerNetReportProducerIdentity
BuildPhase4ConfirmatoryH4096SessionV5SameRunPerNetReportProducerIdentity() noexcept {
  return Phase4H4096SessionV5SameRunPerNetReportProducerIdentity{
      ...
      .superseded_raw_authority = "phase4_confirmatory_same_run_raw_evidence_v2",
      .retained_raw_predecessor_authority = "phase4_confirmatory_same_run_raw_evidence_v1",
      .telemetry_required = true,
      .telemetry_authority = "phase4_confirmatory_same_run_decision_telemetry_v3",
      .superseded_telemetry_authority = "phase4_confirmatory_same_run_decision_telemetry_v2",
      .retained_telemetry_predecessor_authority =
      ...
      .raw_pair_attempt_count = 20,
      .raw_arm_attempt_count = 40,
      .telemetry_schema_version = 1,
      .telemetry_wire_schema_version = 2,
      .telemetry_pair_capture_count = 20,
      .telemetry_arm_capture_count = 40,
      .telemetry_workload_net_count_per_arm = 6,
      .telemetry_total_per_net_row_count = 240,
      .report_schema_version = 1,
      .report_raw_wire_schema_version = 2,
      .report_reference_repetition = 0,
      .report_reference_execution_order = Phase4TrialOrder::kBaselineFirst,
      .report_arm_count = 2,
      .workload_net_count_per_arm = 6,
      .total_report_per_net_row_count = 12,
      .workload_net_roster_checksum = 12'521'697'377'381'992'336ULL,
      ...
      .canonical_algorithm_budget_checksum = 13'645'569'624'513'409'309ULL,
      .paired_semantic_budget_checksum = 12'493'092'620'111'240'227ULL,
  };
}

std::optional<Phase4PairedTrialError>
PreflightPhase4ConfirmatoryH4096SessionV5SameRunPerNetReportProducer(
    const Phase4H4096SessionV5SameRunPerNetReportProducerIdentity& identity,
    const Phase4H4096SessionV5ControllerSourceAssociation& source) {
  if (!(identity == BuildPhase4ConfirmatoryH4096SessionV5SameRunPerNetReportProducerIdentity())) {
    return Phase4PairedTrialError{
        .code = Phase4PairedTrialErrorCode::kMeasurementAssociation,
        .invariant_id = kPhase4H4096SessionV5SameRunPerNetReportProducerInvariant,
        .detail =
            "the complete same-run Session-v5 report-producer identity does not match its "
            "compiled authority",
    };
  }
  return PreflightPhase4ConfirmatoryH4096SessionV5Controller(
      BuildPhase4ConfirmatoryH4096SessionV5PreflightIdentity(
          Phase4H4096SessionV5Carrier::kSameRun, Phase4H4096SessionV5Endpoint::kController),
      BuildPhase4ConfirmatoryH4096SessionV5CanonicalCell(Phase4H4096SessionV5Carrier::kSameRun),
      source);
}
